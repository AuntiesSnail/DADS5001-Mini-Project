...
>ข้อมูลค่อนข้าง clean แต่ประเด็นที่น่าสงสัยคือ Avg_Utilization_Ratio เท่ากับ 0 คือลูกค้าไม่เคยใช้บัตรเลย มีอยู่ 2,470 คน แต่ที่ตัวแปร Months_on_book พบว่าเป็นลูกค้าใช้บริการมาแล้ว 13 เดือนขึ้นไปทุกคน และใช้บริการมากสุด 56 เดือน (เกือบ 5 ปี) แต่ไม่เคยใช้บัตร ซึ่งอาจมีการทำธุรกรรมกับธนาคารในรูปแบบอื่น
...
พบว่าลูกค้าส่วนใหญ่เป็นกลุ่มลูกค้าที่มีระดับรายได้น้อยกว่า $40K และมีระดับการศึกษาเป็นระดับปริญา
